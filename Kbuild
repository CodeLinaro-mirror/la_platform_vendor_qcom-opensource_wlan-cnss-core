...
ifneq ($(CONFIG_CNSS_RDDM_SHUTDOWN),)
     KBUILD_CPPFLAGS += -DCONFIG_CNSS_RDDM_SHUTDOWN
endif

ifneq ($(CONFIG_CNSS_TIMEOUT_SHUTDOWN),)
     KBUILD_CPPFLAGS += -DCONFIG_CNSS_TIMEOUT_SHUTDOWN
endif
